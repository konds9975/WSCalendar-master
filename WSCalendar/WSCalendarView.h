...
@interface WSCalendarView : UIView
{
    ...
    __weak IBOutlet UILabel *lbl5;
    __weak IBOutlet UILabel *lbl6;
    __weak IBOutlet UILabel *lbl7;
    
    __weak IBOutlet UIBarButtonItem *barBtnprvmonth;
    __weak IBOutlet UIBarButtonItem *barBtnnextMonth;
